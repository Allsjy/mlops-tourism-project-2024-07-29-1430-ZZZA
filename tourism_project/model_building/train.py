...
mlflow.set_tracking_uri("https://scrawny-coexist-fancied.ngrok-free.dev")   # complete the code to set the MLflow tracking URI
mlflow.set_experiment("Wellness_Tourism_Package_Prediction")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    ...
    'xgbclassifier__colsample_bytree': [0.6, 0.8],    # Fraction of features sampled when building each tree.
    'xgbclassifier__colsample_bylevel': [0.6, 0.8],   # Fraction of features sampled at each tree level.
